...
#def calc_inst_speed(depths, pitch_lf, fs, stroke_frq, stroke_ratio):
...
#    stroke_ratio: float
#        number that multiplied by the stroke_frq gives the cut-off frequency Wn,
#        of the low pass filter. `stroke_ratio` is a fraction of stroke_frq e.g., 0.4.
#    ind:
...
#    cutoff = stroke_ratio * stroke_frq
#
